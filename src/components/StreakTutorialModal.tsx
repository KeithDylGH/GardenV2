...
const StreakTutorialModal: React.FC<StreakTutorialModalProps> = ({
  isOpen,
  onClose,
  onAddHoursClick,
  themeColor,
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-sm p-6 text-center ${
            !performanceMode && isOpen ? "animate-boingIn" : ""
          ...
          <div className="text-slate-600 dark:text-slate-300 mb-6 text-left space-y-2 text-sm">
            {hasLoggedHours && (
              <p className="font-semibold text-center mb-2">
                ¡Excelente! Ya registraste tus primeras horas y tu racha está en
                marcha.
              </p>
            )}
            <p>✅ Tu racha aumenta por cada día que registras horas.</p>
            <p>
              🛡️ Los <strong>fines de semana</strong> y tu{" "}
              <strong>día de descanso</strong> semanal no rompen tu racha.
            </p>
            <p>
              ❗️ Si olvidas registrar horas un día no protegido, tu racha se
              reiniciará.
            </p>
          </div>
